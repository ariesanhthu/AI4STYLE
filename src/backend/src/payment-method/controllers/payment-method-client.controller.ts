...
import { paymentMethodResponseSchema } from "../dtos";
import { ApiZodErrorResponse, ApiZodResponse, Public } from "../../shared/decorators";
...
export class PaymentMethodClientController {
  ...
  @ApiZodResponse({ status: 200, schema: paymentMethodResponseSchema.array(), description: "Payment methods retrieved successfully" })
