...
import { getListUserSchema, userResponseSchema, type GetListUserDto } from "../dtos";
import { ApiBearerAuth, ApiOperation, ApiSecurity, ApiTags } from "@nestjs/swagger";
import { ApiZodErrorResponse, ApiZodQuery, ApiZodResponse, ZodQuery } from "../../shared/decorators";
...
export class UserAdminController extends BaseUserController {
  ...
  @ApiZodResponse({ status: 200, schema: createPaginationCursorResponseSchema(userResponseSchema), description: 'List of users retrieved successfully' })
