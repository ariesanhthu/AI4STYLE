...
import { ApiZodBody, ApiZodErrorResponse, ApiZodQuery, ApiZodResponse, CurrentUser, ZodBody, ZodQuery } from "../../shared/decorators";
...
export class OrderClientController extends BaseOrderController {
  ...
  @ApiZodResponse({ status: 201, schema: orderResponseSchema, description: "Order created successfully" })
  ...
  @ApiZodResponse({ status: 200, schema: createPaginationCursorResponseSchema(orderResponseSchema), description: "List of user orders retrieved successfully" })
