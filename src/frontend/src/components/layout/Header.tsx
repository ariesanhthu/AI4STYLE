...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white border-b border-purple-100 shadow-sm">
      <div className="container mx-auto px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="flex items-center space-x-8">
            ...
            <Link 
              href="/cart" 
              className="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors flex items-center space-x-1"
            >
