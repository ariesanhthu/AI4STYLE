import { RoleAdminController_createRole_Request, RoleAdminController_createRole_Response, RoleAdminController_deleteRole_Params, RoleAdminController_deleteRole_Request, RoleAdminController_deleteRole_Response, RoleAdminController_getListPermissions_Response, RoleAdminController_getListRoles_Params, RoleAdminController_getListRoles_Request, RoleAdminController_getListRoles_Response, RoleAdminController_getRoleById_Request, RoleAdminController_getRoleById_Response, RoleAdminController_updateRole_Request, RoleAdminController_updateRole_Response } from "@/lib/open-api-client/type.admin";
